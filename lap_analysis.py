...
class LapAnalysis:
    ...
    def get_acceleration(self):
        if self.a is None:
            ...
            a = medfilt(a, kernel_size=self.acc_window)
            self.a = a
        return self.a
    ...
    def get_curvature_spl(self):
        ...
        ssC = savgol_filter(ssC, window_length=self.curvature_window, polyorder=3)
        self.ssC = ssC
        return self.ssC
    ...
    def get_latacceleration_nofilter(self):
        ay = np.square(self.v) * self.get_curvature_nofilter() / 9.81
    ...
    def get_lateral_acceleration(self):
        ...
        # ay = np.clip(ay, -self.g_thresh, self.g_thresh)
        ay = savgol_filter(ay, window_length=self.lat_window, polyorder=3)
        self.ay = ay
        return self.ay
