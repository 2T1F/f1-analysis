...
os.makedirs("plots/trackplot/filter", exist_ok=True)
...
fig.savefig("plots/trackplot/filter/trackplot.svg")
...
make_table(ax3, table_data, "Corner Averages", ["Corner", "Speed (km/h)", "Lat Acc (g)"])
fig.savefig("plots/trackplot/filter/corner_averages.svg")

fig, ax2 = plt.subplots()
lap_analysis.dis_lat_scatter(ax2)
# mark_corners_on_plot(ax2, used_exit)
ax2.set_title("Lateral Acceleration")
ax2.set_xlabel("Distance (m)")
ax2.set_ylabel("Lateral Acceleration (g)")
ax2.legend()
ax2.grid()
fig.savefig("plots/trackplot/filter/lateral_acceleration.svg")
...
fig.savefig("plots/trackplot/filter/curvature.svg")
...
fig.savefig("plots/trackplot/filter/acceleration.svg")
...
ax6.grid()
# Save the speed plot
fig.savefig("plots/trackplot/filter/speed.svg")
